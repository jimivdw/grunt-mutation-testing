 ...
 * @private
 */
KarmaServerManager.prototype._setStatus = function(status) {
    this._status = status;
 ...
 */
KarmaServerManager.prototype.start = function() {
 ...
 */
KarmaServerManager.prototype.runTests = function() {
    var self = this,
        deferred = Q.defer(),
        runnerTimeout,
 ...
 */
KarmaServerManager.prototype.stop = function() {
    if(!this.isStopped()) {
 ...
 */
KarmaServerManager.prototype.kill = function() {
    this._serverProcess.send({ command: 'stop' });
 ...
 */
KarmaServerManager.prototype.isActive = function() {
 ...
 */
KarmaServerManager.prototype.isStopped = function() {
